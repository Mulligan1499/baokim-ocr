...
- Taxonomy 13 doc types inline trong SKILL.md, chưa tách `references/` — sẽ refactor tuần 3 (Option A roadmap đã chốt)
- 7/13 doc types có critical_fields defaults, 6 còn lại (contract_vi, contract_foreign, bank_statement, legal_document, company_charter, power_of_attorney, employment_contract) cần dev truyền explicit
