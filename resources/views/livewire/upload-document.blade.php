<div class="space-y-6">
    ...
    <form wire:submit="submit" class="space-y-4">
        <label for="file"
               ...
               "
               :class="dragging ? 'border-gray-600 bg-gray-50' : 'border-gray-300 bg-white'"
               class="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-lg cursor-pointer hover:bg-gray-50 transition">
            ...
            <input id="file" x-ref="fileInput" type="file" wire:model="file" class="hidden"
        ...
        <div class="flex items-center gap-3 flex-wrap">
            <button type="submit"
                    ...
                    wire:loading.class="bg-gray-700! cursor-wait!"
                    wire:target="submit"
                    @disabled(! $file)
                    class="inline-flex items-center justify-center gap-2 whitespace-nowrap min-w-[160px] rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed transition">
